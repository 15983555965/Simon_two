package com.common.modules.image;
...
import com.common.modules.image.transfor.BlurTransformation;
import com.common.modules.image.transfor.RoundedCornersTransformation;
...
public class ImageFetcher extends BaseModule {
    ...
    public void loadRoundedCorner(String url, ImageView imageView) {
        ...
        Glide.with(mContext)
                ...
                .bitmapTransform(new CenterCrop(pool),
                        new RoundedCornersTransformation(pool, UIUtils.dip2px(2), 2))
                .crossFade()
                .into(imageView);
    }
    ...
    public void loadBlur(String url, ImageView imageView, int mRadius) {
        ...
        Glide.with(mContext)
                .load(url)
                .bitmapTransform(new CenterCrop(pool),
                        new BlurTransformation(mContext, pool, mRadius))
                .crossFade()
                .into(imageView);
    }
