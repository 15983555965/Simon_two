package com.common.modules.logstatistics;
...
//        	Countly.sharedInstance().onStart();
        ...
        //add common log
        LogUtils.d(event.getLogParams().logName + "|startTracking...");
    ...
    public static synchronized void stopTracking(ILogEvent event) {
        ...
        checkInitial();
        //add common log
        LogUtils.d(event.getLogParams().logName + "|stopTracking...");
        LogUtils.d("Current#" + asInstance().mCurrent.getLogParams().logName + "|stopTracking...");
...
//        	Countly.sharedInstance().onStop();
    ...
    private static void trackUi(double duration, String from, String to) {
        ...
        LogUtils.d("log tracking ui : from " + from + " to " + to + " duration " + duration);
        if (asInstance().mCountlyEnable) {
